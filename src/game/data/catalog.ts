...
export const BUILDINGS: BuildingDef[] = [
  {
    ...
    name: "Pioneer Hut",
    category: "house",
    blurb: "Four pioneers. They eat grain and pay a thin tax.",
    cost: { lumber: 10 },
    terrain: "land",
    workers: 0,
    popCap: 4,
  ...
  },
  {
    ...
    name: "Wharf",
    category: "civic",
    blurb: "Ships, Europe, and the whole New World.",
  ...
  },
  {
    ...
    name: "Schoolhouse",
    category: "civic",
    blurb: "Letters and figures. The isle produces more.",
    cost: { planks: 16, cloth: 2 },
    terrain: "land",
    workers: 1,
    popCap: 0,
  ...
  },
  {
    ...
    name: "Market",
    category: "civic",
    blurb: "Turns spare grain into coin when the hold is full.",
    cost: { planks: 12 },
    terrain: "land",
    workers: 1,
    popCap: 0,
  ...
  },
  {
    ...
    category: "civic",
    blurb: "A capital. Prestige enough to write a charter of your own.",
...
> = {
  england: {
    id: "england",
    name: "England",
    motto: "Liberty takes root.",
    blurb: "An extra settler and louder bells. The Crown watches closely.",
    gold: 180,
    settlers: 5,
    militia: 0,
    muskets: 0,
  ...
  netherlands: {
    ...
    motto: "The hold is the empire.",
    blurb: "Fatter prices and a roomier caravel.",
    gold: 220,
    settlers: 4,
    militia: 0,
    muskets: 0,
...
export const FATHERS: {
...
}[] = [
  {
    ...
    name: "William Penn",
    at: 10,
    blurb: "Treaties hold. Native relations rise.",
  },
  {
    id: "franklin",
  ...
  },
  {
    ...
    name: "Thomas Paine",
    at: 36,
    blurb: "Pamphlets. Liberty bells ring harder.",
  },
  {
    id: "washington",
...
> = {
  haven: {
    name: "Haven Isle",
    blurb: "Your landfall. Mixed timber, grass, and a hill or two.",
    climate: "temperate",
  },
  kaneska: {
    name: "Kaneska",
...
export const ART: Record<string, string> = {
  hut: "/game/buildings/hut.png",
  cottage: "/game/buildings/cottage.png",
  townhouse: "/game/buildings/townhouse.png",
  manor: "/game/buildings/manor.png",
  patriot: "/game/buildings/townhouse.png",
  farm: "/game/buildings/farm.png",
  fishery: "/game/buildings/fishery.png",
  lumber: "/game/buildings/lumber.png",
  cotton: "/game/buildings/cotton.png",
  tobacco: "/game/buildings/tobacco.png",
  sugar: "/game/buildings/sugar.png",
  trapper: "/game/buildings/lumber.png",
  mine: "/game/buildings/mine.png",
  silver: "/game/buildings/mine.png",
  sawmill: "/game/buildings/sawmill.png",
  weaver: "/game/buildings/weaver.png",
  distillery: "/game/buildings/distillery.png",
  cigarmaker: "/game/buildings/weaver.png",
  furrier: "/game/buildings/weaver.png",
  smithy: "/game/buildings/smithy.png",
  armory: "/game/buildings/barracks.png",
  warehouse: "/game/buildings/warehouse.png",
  dock: "/game/buildings/dock.png",
  hall: "/game/buildings/hall.png",
  ...
  ship: "/game/props/ship.png",
  village: "/game/props/village.png",
};

export const TILE_ART: Record<Terrain, string> = {
  water: "/game/tiles/water.png",
  sand: "/game/tiles/sand.png",
  grass: "/game/tiles/grass.png",
  forest: "/game/tiles/forest.png",
  hills: "/game/tiles/hills.png",
};
